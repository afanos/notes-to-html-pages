...
- Includes the `简洁` style preset with a compact title area, clickable table of contents, right-side wide-screen navigation, red section numbers, and soft quote boxes.
